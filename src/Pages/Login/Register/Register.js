    ...
    return (
        <div className='w-1/2 mx-auto mt-10 border border-primary shadow-xl rounded p-10 bg-indigo-950'>
            ...
            <form onSubmit={handleSubmit(handleFormData)} className='flex flex-col gap-4'>
                ...
                <input type="submit" value={'Register'} className="btn btn-outline btn-primary mt-5" />
            </form>
            <span>Already have an account? <Link to='/login' className="btn btn-active btn-link">Login</Link></span>
        </div>
    );
};
